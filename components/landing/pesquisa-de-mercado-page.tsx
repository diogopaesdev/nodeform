...
import {
  ...
  BarChart2, Clock, FileBarChart2, Download, GitBranch, Sparkles,
...
const PROBLEMS = [
  "Montar questionários no Google Forms gasta horas — e no final os dados chegam desorganizados, sem lógica entre as perguntas",
  "Entrevistados respondem perguntas que não se aplicam ao perfil deles, gerando ruído e comprometendo a validade dos dados",
  "Exportar e cruzar respostas vira trabalho manual em planilha — sem tempo real, sem filtros, sem insights automáticos",
  "Pesquisas longas afastam respondentes a meio caminho — a taxa de abandono destrói a amostragem antes de terminar",
];

const STEPS = [
  {
    n: "01",
    title: "Monte o fluxo da pesquisa visualmente",
    desc: "Arraste blocos no editor node-based. Configure perguntas, ramificações por perfil e critérios de elegibilidade — tudo se adapta por resposta, sem uma linha de código.",
  },
  {
    n: "02",
    title: "Colete dados com rigor metodológico",
    desc: "Cada respondente percorre apenas o caminho relevante para seu perfil. O fluxo condicional garante qualidade de dados que Google Forms e SurveyMonkey não entregam.",
  },
  {
    n: "03",
    title: "Exporte resultados prontos para análise",
    desc: "Dashboard em tempo real, exportação em CSV e filtros por resposta — os dados chegam organizados para o relatório, sem pivô manual em planilha.",
  },
];
...
const BENEFITS = [
  {
    ...
    color: "text-blue-500",
    bg: "bg-blue-50",
    title: "Fluxo condicional real",
    desc: "Cada pergunta aparece só para quem é relevante. Elimine ruído, aumente qualidade e reduza o tempo de resposta em até 40%.",
  },
  {
    icon: Database,
    color: "text-purple-500",
    bg: "bg-purple-50",
    title: "Dados organizados desde a coleta",
    desc: "Nada de planilha suja com campos em branco. Cada resposta entra estruturada e pronta para análise ou cruzamento.",
  },
  {
    icon: BarChart2,
    color: "text-green-600",
    bg: "bg-green-50",
    title: "Dashboard com resultados em tempo real",
    desc: "Acompanhe respostas conforme chegam — sem esperar o encerramento para ver o que está acontecendo.",
  },
  {
    icon: Download,
    color: "text-orange-500",
    bg: "bg-orange-50",
    title: "Exportação limpa para relatório",
    desc: "CSV organizado por pergunta e respondente, pronto para importar em Power BI, Excel ou qualquer ferramenta de análise.",
  },
  {
    icon: Users,
    color: "text-rose-500",
    bg: "bg-rose-50",
    title: "Controle de elegibilidade por perfil",
    desc: "Bloqueie respondentes fora do escopo antes de começar. Defina critérios por especialidade, faixa etária, cargo ou qualquer atributo.",
  },
  {
    icon: Sparkles,
    color: "text-amber-500",
    bg: "bg-amber-50",
    title: "IA monta o questionário por você",
    desc: "Descreva o objetivo da pesquisa e a IA cria o fluxo completo com perguntas, opções e lógica condicional — em segundos.",
  },
];
...
const OBJECTIONS = [
  {
    ...
    a: "Não. O editor visual funciona por arrastar e soltar — qualquer pesquisador ou analista cria e publica o fluxo em menos de 30 minutos, sem código.",
  },
  {
    q: "Já uso SurveyMonkey ou Google Forms. O que muda?",
    a: "Essas ferramentas não têm fluxo condicional real por opção de resposta. No SurveyFlow, cada respondente percorre um caminho diferente com base nas respostas anteriores — o que aumenta qualidade de dados e reduz abandono.",
  },
  {
  ...
  },
  {
    ...
    a: "Você exporta as respostas em CSV com uma coluna por pergunta, organizado por respondente. Compatível com Excel, Power BI, R, Python e qualquer ferramenta de análise.",
  },
  {
    q: "Posso limitar quem responde a pesquisa?",
    a: "Sim. Com o Módulo Respondentes, você autentica participantes via OTP ou SSO e define critérios de elegibilidade por perfil. Só quem atende os critérios consegue iniciar.",
  },
];
...
const PLAN_FEATURES = [
  ...
  "Critérios de elegibilidade por pergunta",
...
export function PesquisaDeMercadoPage() {
    ...
    <div className="min-h-screen text-gray-900 antialiased">
      ...
      <section className="pt-[96px] pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 h-7 px-3 rounded-full border border-blue-200 bg-blue-50 text-[12px] text-blue-600 font-medium mb-8"
          >
            <FileBarChart2 className="w-3.5 h-3.5" />
            Solução para Pesquisa de Mercado
          </motion.div>
          ...
          >
            Pesquisas de mercado com{" "}
            <span className="relative inline-block">
              <span className="relative z-10">dados confiáveis de verdade</span>
              <motion.span
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
                transition={{ duration: 0.5, delay: 0.72, ease: [0.22, 1, 0.36, 1] }}
                className="absolute bottom-1.5 inset-x-0 h-[10px] bg-blue-100 origin-left -z-0 rounded"
              />
            </span>
          </motion.h1>
          ...
          >
            Fluxo condicional que adapta cada pergunta ao perfil do respondente — colete dados limpos, reduza abandono e exporte resultados prontos para o relatório, sem planilha manual.
          </motion.p>
          ...
          >
            ...
            >
              Criar minha pesquisa grátis <ArrowRight className="w-4 h-4" />
            </button>
            <a
              href={WHATSAPP_URL}
              target="_blank"
        ...
        <div className="max-w-4xl mx-auto">
          <FadeUp className="text-center mb-14">
            ...
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
              Por que pesquisas com formulários tradicionais falham?
            </h2>
            <p className="text-[16px] text-gray-500 mt-3 max-w-xl mx-auto">
              Google Forms, SurveyMonkey e Typeform foram feitos para perguntas simples — não para pesquisa de mercado com rigor metodológico.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.32} className="mt-10 text-center">
            <p className="text-[15px] font-semibold text-gray-900">
              O SurveyFlow foi construído para pesquisas que precisam de mais do que caixinhas genéricas.
            </p>
          </FadeUp>
        </div>
      </section>
      ...
      <section id="solucao" className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <FadeUp className="text-center mb-16">
            <p className="text-[12px] font-semibold text-blue-500 uppercase tracking-widest mb-3">Como funciona</p>
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
              Da coleta ao relatório em 3 passos
            </h2>
            <p className="text-[16px] text-gray-500 mt-3">Sem código, sem planilha manual, sem perder respondentes no meio do caminho.</p>
          </FadeUp>
      ...
      <section id="beneficios" className="py-24 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <FadeUp className="text-center mb-16">
            <p className="text-[12px] font-semibold text-blue-500 uppercase tracking-widest mb-3">Benefícios</p>
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
      ...
      <section id="prova" className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          <FadeUp className="text-center">
            <p className="text-[12px] font-semibold text-blue-500 uppercase tracking-widest mb-10">Caso real</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[14px] font-semibold text-blue-900 mb-2">
                    Oncologia — o caso de maior exigência metodológica em pesquisa de saúde
                  </p>
                  <p className="text-[13px] text-blue-700 leading-relaxed">
                    Se o SurveyFlow atende pesquisa clínica com rigor de oncologia — coleta estruturada, fluxo condicional, critérios de elegibilidade e exportação para análise — ele atende qualquer estudo de mercado, segmentação de consumidores ou diagnóstico de satisfação.
                  </p>
                </div>
              </div>
            </div>
        ...
        <FadeUp>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-[28px] sm:text-[36px] font-extrabold text-white tracking-tight leading-tight mb-4">
              Crie sua primeira pesquisa em menos de 30 minutos
            </h2>
      ...
      <section id="objections" className="py-24 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <FadeUp className="text-center mb-12">
            <p className="text-[12px] font-semibold text-blue-500 uppercase tracking-widest mb-3">Tire suas dúvidas</p>
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
      ...
      <section id="preco" className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <FadeUp className="text-center mb-14">
            <p className="text-[12px] font-semibold text-blue-500 uppercase tracking-widest mb-3">Plano único · Sem surpresas</p>
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            <FadeUp className="space-y-5">
              {[
                { icon: Zap, color: "bg-blue-50 text-blue-500", title: "Comece em segundos", desc: "Login com Google, crie a pesquisa e publique — tudo em menos de 30 minutos." },
                ...
                { icon: TrendingUp, color: "bg-orange-50 text-orange-500", title: "Cancele quando quiser", desc: "Sem fidelidade, sem taxa de cancelamento. Você controla." },
              ].map((item) => (
        ...
        <FadeUp>
          <div className="max-w-5xl mx-auto bg-gray-950 rounded-3xl px-8 py-16 text-center">
            <h2 className="text-[30px] sm:text-[42px] font-extrabold tracking-[-0.02em] leading-tight text-white mb-4">
              Pronto para coletar dados que realmente geram insights?
            </h2>
