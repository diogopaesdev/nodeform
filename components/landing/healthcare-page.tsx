...
import {
  ...
  Stethoscope, Clock, BarChart2, Lock, Sparkles,
...
const PROBLEMS = [
  "Formulários genéricos coletam respostas de profissionais ou pacientes fora do escopo — corrompendo a amostragem e invalidando o estudo antes de terminar",
  "Pesquisas de satisfação de pacientes chegam com dados soltos e inconsistentes: cada hospital exporta numa planilha diferente, sem padrão para consolidar",
  "Equipes de pesquisa clínica perdem horas recodificando respostas abertas porque o questionário não foi estruturado com lógica condicional desde o início",
  "Conformidade LGPD e coleta de consentimento informado viram obstáculos operacionais — sistemas separados, assinaturas manuais, risco jurídico desnecessário",
];

const STEPS = [
  {
    n: "01",
    title: "Monte o fluxo por perfil do respondente",
    desc: "Arraste blocos no editor visual. Configure perguntas por especialidade, cargo ou fase do tratamento — cada respondente percorre só o caminho relevante para ele, sem código.",
  },
  {
    n: "02",
    title: "Colete dados com rigor e conformidade",
    desc: "Critérios de elegibilidade bloqueiam respondentes fora do escopo antes de começar. Consentimento informado e aceite LGPD entram direto no fluxo, documentados automaticamente.",
  },
  {
    n: "03",
    title: "Exporte resultados prontos para análise",
    desc: "Dashboard em tempo real, exportação em CSV estruturado por respondente — sem pivô manual. Compatível com Power BI, R, Python e qualquer ferramenta de análise clínica.",
  },
];
...
const BENEFITS = [
  {
    ...
    color: "text-teal-600",
    bg: "bg-teal-50",
    title: "Fluxo condicional por especialidade",
    desc: "Cada pergunta aparece só para quem é relevante. Cardiologista não vê perguntas de oncologia. Reduza abandono e elimine ruído de dados em uma etapa só.",
  },
  {
    icon: Users,
    color: "text-blue-600",
    bg: "bg-blue-50",
    title: "Elegibilidade por perfil clínico",
    desc: "Defina critérios por CRM, cargo, especialidade ou fase do protocolo. Só respondentes dentro do escopo conseguem iniciar — sem triagem manual posterior.",
  },
  {
    icon: BarChart2,
    color: "text-indigo-600",
    bg: "bg-indigo-50",
    title: "Dashboard clínico em tempo real",
    desc: "Acompanhe respostas conforme chegam, filtre por segmento e identifique padrões antes do encerramento da coleta — sem esperar a exportação final.",
  },
  {
    icon: FileCheck,
    color: "text-green-600",
    bg: "bg-green-50",
    title: "LGPD e consentimento no fluxo",
    desc: "Aceite de termos, consentimento informado e coleta de dados documentados direto no formulário. Sem apps adicionais, sem assinatura manual, sem risco jurídico.",
  },
  {
    icon: Lock,
    color: "text-purple-600",
    bg: "bg-purple-50",
    title: "Acesso autenticado para participantes",
    desc: "OTP por e-mail ou integração SSO com sistemas hospitalares. Cada respondente acessa uma única vez, com identidade verificada e trilha de auditoria.",
  },
  {
    icon: Sparkles,
    color: "text-amber-500",
    bg: "bg-amber-50",
    title: "IA monta o questionário clínico",
    desc: "Descreva o objetivo do estudo e a IA cria o fluxo completo com perguntas, ramificações e critérios de elegibilidade — em segundos, sem metodologista.",
  },
];
...
const OBJECTIONS = [
  ...
  },
  {
    ...
    a: "Você configura critérios de elegibilidade por qualquer atributo — especialidade, CRM, cargo, instituição. Respondentes fora do escopo são bloqueados antes de acessar a primeira pergunta. Opcionalmente, você autentica cada participante via OTP ou SSO.",
  },
  {
    q: "A coleta de dados está em conformidade com a LGPD?",
    a: "O aceite de termos e o consentimento informado entram direto no fluxo do formulário, com registro de data, IP e confirmação explícita. Você coleta apenas o que configura — sem dados extras armazenados por padrão.",
  },
  {
    q: "Preciso de um desenvolvedor para implementar?",
    a: "Não. O editor visual funciona por arrastar e soltar. Qualquer pesquisador ou coordenador clínico monta e publica o fluxo em menos de 30 minutos, sem código e sem suporte de TI.",
  },
  {
    q: "Como funciona a exportação para análise estatística?",
    a: "Você exporta as respostas em CSV com uma coluna por pergunta, organizado por respondente. Compatível com R, Python, SPSS, Excel, Power BI e qualquer ferramenta de análise epidemiológica ou de mercado em saúde.",
  },
];

const PLAN_FEATURES = [
  "Pesquisas e formulários ilimitados",
  "Fluxo condicional por resposta e perfil",
  "Critérios de elegibilidade por respondente",
  "Dashboard e analytics em tempo real",
  "Exportação de dados (CSV estruturado)",
  "Consentimento LGPD integrado ao fluxo",
  "Autenticação de respondentes (OTP/SSO)",
...
export function HealthcarePage() {
  ...
  return (
    <div className="min-h-screen text-gray-900 antialiased">
      ...
      <section className="pt-[96px] pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 h-7 px-3 rounded-full border border-teal-200 bg-teal-50 text-[12px] text-teal-700 font-medium mb-8"
          >
            <Stethoscope className="w-3.5 h-3.5" />
            Solução para Healthcare
          </motion.div>
          ...
          >
            Coleta de dados clínicos com{" "}
            <span className="relative inline-block">
              <span className="relative z-10">rigor metodológico real</span>
              <motion.span
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
                transition={{ duration: 0.5, delay: 0.72, ease: [0.22, 1, 0.36, 1] }}
                className="absolute bottom-1.5 inset-x-0 h-[10px] bg-teal-100 origin-left -z-0 rounded"
              />
            </span>
          </motion.h1>
          ...
          >
            Fluxo condicional que adapta cada pergunta ao perfil do profissional ou paciente — elegibilidade automática, consentimento LGPD integrado e exportação pronta para análise, sem planilha manual.
          </motion.p>
          ...
          >
            ...
            >
              Criar meu formulário clínico grátis <ArrowRight className="w-4 h-4" />
            </button>
            <a
              href={WHATSAPP_URL}
              target="_blank"
      ...
      {/* ─ Social proof strip ─────────────────────────────────────────────── */}
      <div className="py-6 px-6 border-y border-gray-100 bg-gray-50/60">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12">
          {[
            { label: "Pesquisas ativas", value: "100+" },
            { label: "Respondentes gerenciados", value: "10.000+" },
            { label: "Campos coletados por pesquisa", value: "até 200" },
          ].map((s) => (
            <div key={s.label} className="text-center">
              <p className="text-[22px] font-extrabold text-gray-900 tracking-tight">{s.value}</p>
        ...
        <div className="max-w-4xl mx-auto">
          <FadeUp className="text-center mb-14">
            ...
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
              Por que a coleta de dados em saúde falha com formulários comuns?
            </h2>
            <p className="text-[16px] text-gray-500 mt-3 max-w-xl mx-auto">
              Google Forms e SurveyMonkey foram feitos para questionários simples — não para coleta estruturada em ambiente clínico ou de pesquisa em saúde.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.32} className="mt-10 text-center">
            <p className="text-[15px] font-semibold text-gray-900">
              O SurveyFlow foi construído para pesquisas que exigem mais do que campos genéricos.
            </p>
          </FadeUp>
        </div>
      </section>
      ...
      <section id="solucao" className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <FadeUp className="text-center mb-16">
            <p className="text-[12px] font-semibold text-teal-600 uppercase tracking-widest mb-3">Como funciona</p>
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
              Da coleta ao insight clínico em 3 passos
            </h2>
            <p className="text-[16px] text-gray-500 mt-3">Sem código, sem planilha manual, sem perder respondentes no meio da pesquisa.</p>
          </FadeUp>
      ...
      <section id="beneficios" className="py-24 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <FadeUp className="text-center mb-16">
            <p className="text-[12px] font-semibold text-teal-600 uppercase tracking-widest mb-3">Benefícios</p>
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
              O que sua equipe de saúde ganha de verdade
            </h2>
          </FadeUp>
      ...
      <section id="prova" className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          <FadeUp className="text-center">
            <p className="text-[12px] font-semibold text-teal-600 uppercase tracking-widest mb-10">Caso real</p>
          ...
          <FadeUp delay={0.1} className="mt-12">
            <div className="bg-teal-50 border border-teal-100 rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[14px] font-semibold text-teal-900 mb-2">
                    Oncologia — o padrão mais exigente em pesquisa clínica e de mercado em saúde
                  </p>
                  <p className="text-[13px] text-teal-800 leading-relaxed">
                    Se o SurveyFlow atende pesquisa clínica com rigor de oncologia — fluxo condicional, elegibilidade por perfil, consentimento documentado e exportação para análise — ele atende pesquisas de satisfação de pacientes, NPS hospitalar, estudos de farmacovigilância e qualquer coleta estruturada em saúde.
                  </p>
                </div>
              </div>
            </div>
        ...
        <FadeUp>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-[28px] sm:text-[36px] font-extrabold text-white tracking-tight leading-tight mb-4">
              Crie seu primeiro formulário clínico em menos de 30 minutos
            </h2>
            <p className="text-[15px] text-gray-400 mb-8 max-w-lg mx-auto">
              Arraste blocos, configure o fluxo condicional e publique o link — sem desenvolvedor, sem configuração técnica.
            </p>
      ...
      <section id="objections" className="py-24 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <FadeUp className="text-center mb-12">
            <p className="text-[12px] font-semibold text-teal-600 uppercase tracking-widest mb-3">Tire suas dúvidas</p>
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
        ...
        <FadeUp>
          <div className="max-w-5xl mx-auto bg-gray-950 rounded-3xl px-8 py-16 text-center">
            <h2 className="text-[30px] sm:text-[42px] font-extrabold tracking-[-0.02em] leading-tight text-white mb-4">
              Pronto para coletar dados clínicos com rigor e sem retrabalho?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              >
                Criar meu formulário clínico agora
              </button>
              <a
                href={WHATSAPP_URL}
                target="_blank"
