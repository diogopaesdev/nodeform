...
const WHATSAPP_URL = "https://wa.me/5541995311160?text=Ol%C3%A1%2C%20vim%20pela%20p%C3%A1gina%20de%20Cl%C3%ADnicas%20Est%C3%A9ticas%20do%20SurveyFlow%20e%20gostaria%20de%20saber%20mais!";
  ...
  return (
    <div className="min-h-screen text-gray-900 antialiased">
      ...
      <section id="preco" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <FadeUp className="text-center mb-14">
            <p className="text-[12px] font-semibold text-orange-500 uppercase tracking-widest mb-3">Escolha o plano certo para sua clínica</p>
            <h2 className="text-[30px] sm:text-[38px] font-extrabold tracking-[-0.02em] leading-tight text-gray-950">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <FadeUp className="pt-5 flex flex-col">
              <div className="rounded-2xl overflow-hidden border border-gray-200 bg-white shadow-sm flex flex-col flex-1">
                <div className="px-7 pt-7 pb-5 border-b border-gray-100">
                  ...
                  <p className="text-[13px] text-gray-400 mt-2">Comece a capturar e organizar dados rapidamente</p>
                </div>
                <div className="px-7 pt-5 pb-2 flex-1">
                  <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-3">Incluso</p>
                  <ul className="space-y-2">
                    {[
                      "Até 5 triagens/formulários",
            ...
            <FadeUp delay={0.1} className="relative pt-5 flex flex-col">
              ...
              <div className="rounded-2xl overflow-hidden border-2 border-gray-900 shadow-[0_8px_40px_rgba(0,0,0,0.12)] flex flex-col flex-1">
                <div className="px-7 pt-6 pb-5 bg-gray-950">
                  ...
                  <p className="text-[13px] text-gray-500 mt-2">Automatize e escale com mais controle</p>
                </div>
