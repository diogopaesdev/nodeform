...
export const metadata: Metadata = {
  ...
  description:
    "Artigos sobre pesquisas online, formulários com lógica condicional, NPS, qualificação de leads e casos de uso por segmento.",
}
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-5xl mx-auto px-6 py-14 sm:py-20">
          ...
          <h1 className="text-[36px] sm:text-[48px] font-extrabold tracking-[-0.03em] leading-[1.05] text-gray-950 mb-4">
            Pesquisas, formulários<br className="hidden sm:block" /> e fluxos inteligentes
          </h1>
          <p className="text-[16px] text-gray-500 max-w-xl">
            Artigos práticos sobre criação de pesquisas, qualificação de leads, NPS e casos de uso por segmento.
          </p>
        </div>
      </div>
