...
import { getAllPosts, getPostBySlug, CATEGORY_LABELS, formatDate } from "@/lib/blog"
...
export async function generateMetadata({
  ...
  if (!post) return {}
  return {
    title: `${post.pt.title} — SurveyFlow Blog`,
    description: post.pt.description,
  }
}
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 sm:py-20">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-2 text-[13px] text-gray-400">
            ...
            <span>{formatDate(post.date, "pt")}</span>
          </div>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: post.pt.content }}
        />

        {/* CTA */}
        <div className="mt-10 p-6 bg-gray-900 rounded-2xl text-white text-center">
          <p className="text-[18px] font-bold mb-2">Pronto para começar?</p>
          <p className="text-[14px] text-gray-400 mb-5">7 dias grátis, sem cartão de crédito.</p>
          <Link
            href="/"
        ...
        {related.length > 0 && (
          <div className="mt-14">
            <h2 className="text-[18px] font-bold text-gray-950 mb-5">Outros artigos</h2>
